...
<template>
  <div class="min-h-screen w-full flex overflow-hidden bg-[#F5F5F7]">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative bg-black justify-center items-center overflow-hidden">
      ...
      <div class="relative z-10 text-white max-w-xl px-12">
        ...
        <div class="flex items-center gap-4 mb-10">
          ...
          <div class="flex flex-col">
            <span class="text-[11px] tracking-[0.25em] font-medium text-[#A7C5D2] uppercase">Plataforma Municipal</span>
        ...
        <h2 class="text-4xl font-extrabold mb-5 leading-tight">
          ...
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#607C88]">Ciudad</span>
        </h2>
          ...
          <div class="text-center mb-10">
            <div class="hidden lg:flex justify-center mb-6">
              <div class="relative group animate-float">
                ...
                <div class="absolute inset-x-0 -bottom-2 bg-[#607C88]/20 h-4 w-32 mx-auto blur-xl rounded-full animate-shadow-pulse"></div>
              </div>
            </div>
            
            <h1 class="text-3xl font-bold text-gray-900 mb-3 tracking-tight">Iniciar Sesión</h1>
